...
// }, [_id]);
  ...
  <div className="p-6">
   ...
   Available
    ...
    <Link to={`/addBookings/${_id}`}>
            <button
              className="flex items-center gap-2 px-6 py-3 font-sans text-xs font-bold text-center text-[#26917C] uppercase align-middle transition-all rounded-lg select-none hover:bg-pink-500/10 active:bg-pink-500/30"
              type="button"
